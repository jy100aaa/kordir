$(function(){
	...
	tinymce.init({
	    ...
	    plugins: 'link image textcolor uploadpicture template media autoresize code',
			...
			if(response.result == 'ok'){
				draw_general_popup(
						function(){
							...
							location.hash = 'board?url=' + productVariable.tag;
						},
						null,
						null,
						stringTable.registerSuccess,
						stringTable.ok,
						null
				);
			} else {
